...
-- Combined Database Schema - PostgreSQL Version
-- ============================================================
...
CREATE TABLE photographer (
    ...
    pgph VARCHAR(15),
    pgemail VARCHAR(255) NOT NULL UNIQUE,
...
CREATE TABLE client (
    ...
    clph VARCHAR(15),
    clemail VARCHAR(255) NOT NULL UNIQUE,
...
CREATE TABLE package (
    ...
    pkgprice DECIMAL(10,2) CHECK (pkgprice > 0),
...
CREATE TABLE outdoor (
    ...
    distancepriceperkm DECIMAL(8,2) DEFAULT 0,
...
CREATE TABLE payment (
    ...
    remamount DECIMAL(10,2) DEFAULT 0 CHECK (remamount >= 0),
...
VALUES (1, 'Deposit 30%', CURRENT_DATE - 5, 45, 105, 'receipt001.jpg', 'pending');

INSERT INTO payment (bookingid, depopref, depopdate, paidamount, remamount, receipts, paystatus)
VALUES (2, 'Deposit 30%', CURRENT_DATE - 2, 180, 420, 'receipt002.jpg', 'pending');

INSERT INTO payment (bookingid, depopref, depopdate, paidamount, remamount, paystatus)
VALUES (3, 'Deposit 30%', CURRENT_DATE - 1, 60, 140, 'pending');
