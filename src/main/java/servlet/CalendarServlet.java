...
public class CalendarServlet extends HttpServlet {
    ...
    private void getCalendarData(HttpServletRequest request, HttpServletResponse response) 
        ...
        for (Map<String, Object> data : bookingData) {
            JsonObject obj = new JsonObject();
            obj.addProperty("date", (String) data.get("date"));
            obj.addProperty("count", (Integer) data.get("count"));
            obj.addProperty("statuses", (String) data.get("statuses"));
            jsonArray.add(obj);
        }
    ...
    private void getBookingsByDate(HttpServletRequest request, HttpServletResponse response) 
        ...
        for (BookingModel b : bookings) {
            ...
            obj.addProperty("clientName", b.getClientName());
            obj.addProperty("clientPhone", b.getClientPhone());
            obj.addProperty("packageName", b.getPackageName());
            obj.addProperty("packageCateg", b.getPackageCateg());
            obj.addProperty("bookTime", b.getBookTime());
            obj.addProperty("bookPax", b.getBookPax());
            obj.addProperty("totalPrice", b.getTotalPrice());
            obj.addProperty("status", b.getBookStatus());
            obj.addProperty("location", b.getBookLocation());
            obj.addProperty("photographerName", b.getPhotographerName());
            jsonArray.add(obj);
        }
