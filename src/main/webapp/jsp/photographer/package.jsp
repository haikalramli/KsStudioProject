                        ...
                        <header class="top-header">
                            ...
                            <div class="header-actions">
                                <button class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#createIndoorModal">
                                    <i class="bi bi-plus-circle"></i> Add Indoor Package
                                </button>
                                <button class="btn btn-success" data-bs-toggle="modal"
                                    data-bs-target="#createOutdoorModal">
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-2">
                                    <a href="${pageContext.request.contextPath}/package"
                                        class="btn ${empty selectedCategory ? 'btn-primary' : 'btn-outline-secondary'}">All</a>
                                    <a href="${pageContext.request.contextPath}/package?category=Indoor"
                                        class="btn ${selectedCategory == 'Indoor' ? 'btn-primary' : 'btn-outline-secondary'}">Indoor</a>
                                    <a href="${pageContext.request.contextPath}/package?category=Outdoor"
                                        class="btn ${selectedCategory == 'Outdoor' ? 'btn-primary' : 'btn-outline-secondary'}">Outdoor</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <c:forEach var="pkg" items="${packages}">
                                                <tr>
                                                    <td>
                                                        <c:if test="${not empty pkg.pkgImage}">
                                                            <img src="${pageContext.request.contextPath}/${pkg.pkgImage}"
                                                                alt="Package"
                                                                style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px;">
                                                        </c:if>
                                                        <c:if test="${empty pkg.pkgImage}">
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge ${pkg.pkgCateg == 'Indoor' ? 'bg-info' : 'bg-success'}">${pkg.pkgCateg}</span>
                                                    </td>
                                                    <td>RM
                                                        <fmt:formatNumber value="${pkg.pkgPrice}" pattern="#,##0.00" />
                                                    </td>
                                                    <td>${pkg.pkgDuration} hrs</td>
                                                    <td>${pkg.eventType}</td>
                                                    <td>
                                                        <c:if test="${pkg.pkgCateg == 'Indoor'}">
                                                            <small>Pax: ${pkg.numOfPax}<br>Background:
                                                                ${pkg.backgType}</small>
                                                        </c:if>
                                                        <c:if test="${pkg.pkgCateg == 'Outdoor'}">
                                                            <small>Distance: ${pkg.distance} km<br>RM
                                                                ${pkg.distancePricePerKm}/km</small>
                                                        </c:if>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="status-badge status-${pkg.pkgStatus}">${pkg.pkgStatus}</span>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <button class="btn btn-outline-primary"
                                                                onclick="editPackage(${pkg.pkgId})" title="Edit">
                                                                <i class="bi bi-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-outline-danger"
                                                                onclick="deletePackage(${pkg.pkgId})" title="Delete">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" name="pkgPrice" class="form-control" step="0.01"
                                                min="0" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Duration (hours) *</label>
                                            <input type="number" name="pkgDuration" class="form-control" step="0.5"
                                                min="0.5" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="pkgImage" class="form-control" accept="image/*">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" name="pricePerKm" class="form-control" step="0.1"
                                                min="0" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <form action="${pageContext.request.contextPath}/package" method="post"
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Package Name *</label>
                                            <input type="text" name="pkgName" id="editPkgName" class="form-control"
                                                required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Price (RM) *</label>
                                            <input type="number" name="pkgPrice" id="editPkgPrice" class="form-control"
                                                step="0.01" min="0" required>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label class="form-label">Duration (hours) *</label>
                                            <input type="number" name="pkgDuration" id="editPkgDuration"
                                    ...
                                    <div id="editIndoorFields">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Max Pax</label>
                                                <input type="number" name="numOfPax" id="editNumOfPax"
                                    ...
                                    <div id="editOutdoorFields" style="display: none;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label class="form-label">Price per KM (RM)</label>
                                                <input type="number" name="pricePerKm" id="editPricePerKm"
                                                    class="form-control" step="0.1" min="0">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Description</label>
                                        <textarea name="pkgDesc" id="editPkgDesc" class="form-control"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
