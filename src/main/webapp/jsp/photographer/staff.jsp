                                        ...
                                        <tbody>
                                            <c:forEach var="pg" items="${photographers}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge ${pg.pgRole == 'senior' ? 'bg-danger' : (pg.pgRole == 'junior' ? 'bg-primary' : 'bg-warning text-dark')}">
                                                            ${pg.pgRole == 'senior' ? 'Senior (Admin)' : (pg.pgRole ==
                                                            'junior' ? 'Junior' : 'Intern')}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="badge ${pg.pgStatus == 'active' ? 'bg-success' : 'bg-secondary'}">
                                                            ${pg.pgStatus}
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <c:if test="${pg.pgId != sessionScope.photographerId}">
                                                            <button class="btn btn-sm btn-outline-primary"
                                                                onclick="editStaff(${pg.pgId}, '${pg.pgName}', '${pg.pgEmail}', '${pg.pgPh}', '${pg.pgRole}', '${pg.pgStatus}')"
                                                                title="Edit">
                                                                <i class="bi bi-pencil"></i>
                                                            </button>
                                                            <button class="btn btn-sm btn-outline-danger"
                                                                onclick="deleteStaff(${pg.pgId})" title="Delete">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="${pageContext.request.contextPath}/staff" method="post">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Add
                                        Staff</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="${pageContext.request.contextPath}/staff" method="post">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
                                        data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-warning"><i class="bi bi-check-lg"></i> Save
                                        Changes</button>
                                </div>
                            </form>
                        </div>
