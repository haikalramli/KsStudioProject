...
<% 
    // Try to get loginType from attribute (set by servlet on error)
    String loginType = (String) request.getAttribute("loginType");

    // If null, try to get from query string 'type' parameter
    if (loginType == null) {
        loginType = request.getParameter("type");
    }

    // If still null, try 'loginType' parameter (from form submit)
    if (loginType == null) {
    ...
    // Set it back to attribute for EL use
