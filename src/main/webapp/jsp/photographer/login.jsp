<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
        <% // Try to get loginType from attribute (set by servlet on error) String loginType=(String)
            ...
            (from form submit) if (loginType==null) { loginType=request.getParameter("loginType"); } // Default to
            junior if (loginType==null) { loginType="junior" ; } // Set it back to attribute for EL use
            ...
            <head>
                ...
                <style>
                    ...
                    .login-header.junior h1,
                    .login-header.junior p {
                        color: #333;
                    }
                    ...
                    <div class="login-body">
                        ...
                        <form action="${pageContext.request.contextPath}/login" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control ${loginType}-focus" id="email" name="email"
                                    placeholder="Enter your email" required>
                            </div>

                            <div class="form-group">
                                <label for="password"><i class="bi bi-lock"></i> Password</label>
                                <input type="password" class="form-control ${loginType}-focus" id="password"
