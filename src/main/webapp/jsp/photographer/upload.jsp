                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">
                                            Upload Google Drive or cloud links for clients whose <strong>payment has
                                                been fully verified</strong>.
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <fmt:formatDate value="${item.bookDate}"
                                                            pattern="dd MMM yyyy" /><br>
                                                        <small class="text-muted">
                                                            <fmt:formatDate value="${item.bookStartTime}"
                                                                pattern="hh:mm a" />
                                                        </small>
                                                    </td>
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${completedUpload}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="${item.folderLink}" target="_blank"
                                        ...
                                        <tbody>
                                            <c:forEach var="photo" items="${uploadHistory}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="${photo.folderLink}" target="_blank"
                                                            class="btn btn-sm btn-outline-primary">
                                                            <i class="bi bi-folder2-open"></i> View
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <fmt:formatDate value="${photo.folderUpload}"
                                                            pattern="dd/MM/yyyy" />
                                                    </td>
                                                    <td>${photo.photographerName}</td>
                                                    <td>
                                                        <button class="btn btn-sm btn-outline-warning"
                                                            onclick="editPhoto(${photo.folderId}, '${photo.folderName}', '${photo.folderLink}', '${photo.notesForClient}')"
                                                            title="Edit">
                                                            <i class="bi bi-pencil"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-outline-danger"
                                                            onclick="deletePhoto(${photo.folderId})" title="Delete">
                            ...
                            <form action="${pageContext.request.contextPath}/upload" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="folderName" id="uploadFolderName" class="form-control"
                                            required placeholder="e.g., Ahmad_Family_Jan2026">
                                    </div>
                            ...
                            <form action="${pageContext.request.contextPath}/upload" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="notesForClient" id="editNotesText" class="form-control"
                                            rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="border-radius: 16px;">
                            ...
                            <div class="modal-body text-center py-4">
                                ...
                                <p class="text-muted">This action cannot be undone. Client will lose access to photos.
                                </p>
                            </div>
                            <form action="${pageContext.request.contextPath}/upload" method="post">
