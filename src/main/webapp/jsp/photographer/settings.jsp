                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="card text-center">
                                <div class="card-body py-5">
                                    ...
                                    <span
                                        class="badge ${photographer.pgRole == 'senior' ? 'bg-danger' : (photographer.pgRole == 'junior' ? 'bg-primary' : 'bg-success')} fs-6">
                                        ${photographer.pgRole == 'senior' ? 'Senior (Admin)' : (photographer.pgRole ==
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                    value="${photographer.pgName}" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Email *</label>
                                                <input type="email" name="email" class="form-control"
                                                    value="${photographer.pgEmail}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="tel" name="phone" class="form-control"
                                                    value="${photographer.pgPh}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label">Role</label>
                                                <input type="text" class="form-control"
                                                    value="${photographer.pgRole == 'senior' ? 'Senior (Admin)' : (photographer.pgRole == 'junior' ? 'Junior' : 'Intern')}"
                                                    disabled>
