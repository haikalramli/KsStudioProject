                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="border-radius: 16px;">
                            <div class="modal-header"
                                style="background: linear-gradient(135deg, #667eea, #5a67d8); color: #fff; border-radius: 16px 16px 0 0;">
                            ...
                            <div class="modal-body p-4">
                                <div class="mb-3">
                                    <span class="badge" id="modalPackageBadge"
                                        style="font-size: 0.9rem; padding: 8px 16px;">Package Name</span>
                                </div>
