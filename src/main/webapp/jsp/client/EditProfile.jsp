                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card shadow-sm mb-4" style="border-radius: 15px;">
                                <div class="card-header"
                                    style="background: linear-gradient(135deg, #2f5d50, #1a3a32); border-radius: 15px 15px 0 0;">
                                    <h5 class="mb-0 text-white"><i class="bi bi-person-gear"></i> Edit Profile Details
                                    </h5>
                                </div>
                                <div class="card-body p-4">
                                    <form action="${pageContext.request.contextPath}/ClientProfileController"
                                        method="post">
                                        ...
                                        <div class="d-flex gap-3">
                                            ...
                                            <a href="${pageContext.request.contextPath}/jsp/client/ViewAccount.jsp"
                                                class="btn btn-secondary btn-lg px-4" style="border-radius: 10px;">
                                                Cancel
                                            </a>
                                        </div>
                                    </form>
                            ...
                            <div class="card shadow-sm" style="border-radius: 15px;">
                                <div class="card-header"
                                    style="background: linear-gradient(135deg, #dc3545, #c82333); border-radius: 15px 15px 0 0;">
                                ...
                                <div class="card-body p-4">
                                    <form action="${pageContext.request.contextPath}/ClientProfileController"
                                        ...
                                        <button type="button" class="btn btn-warning btn-lg px-4"
                                            style="border-radius: 10px;" onclick="confirmPasswordChange()">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="border-radius: 15px;">
                        <div class="modal-header bg-warning">
                            <h5 class="modal-title"><i class="bi bi-exclamation-triangle"></i> Confirm Password Change
                            </h5>
