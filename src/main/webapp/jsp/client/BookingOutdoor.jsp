            ...
            <% if (session.getAttribute("clientID")==null) { response.sendRedirect("SignIn.jsp"); return; } %>
                ...
                <section class="section light-background" style="padding-top: 100px;">
                    <div class="container section-title" data-aos="fade-up">
                        ...
                        <p>Capture your special moments in beautiful outdoor locations. Perfect for weddings,
                            pre-weddings, and events.</p>
                    </div>
                                ...
                                <div class="col-lg-4 col-md-6" data-aos="fade-up">
                                    <div class="card h-100 shadow-sm border-0">
                                        <div class="card-header"
                                            style="background: linear-gradient(135deg, #2f5d50, #1a3a32); color: white;">
                                            <h5 class="mb-0">${pkg.pkgName}</h5>
                                        </div>
                                        <div class="card-body">
                                            <h3 class="mb-3" style="color: #2f5d50;">RM
                                                <fmt:formatNumber value="${pkg.pkgPrice}" pattern="#,##0.00" />
                                            </h3>
                                            <ul class="list-unstyled">
                                                <li class="mb-2"><i class="bi bi-clock text-muted me-2"></i> Duration:
                                                    ${pkg.pkgDuration} hours</li>
                                                <li class="mb-2"><i class="bi bi-geo-alt text-muted me-2"></i> Location:
                                                    ${pkg.location}</li>
                                                <li class="mb-2"><i class="bi bi-car-front text-muted me-2"></i> Max
                                                    Distance: ${pkg.distance} km</li>
                                                <li class="mb-2"><i class="bi bi-currency-dollar text-muted me-2"></i>
                                                    Extra: RM ${pkg.distancePricePerKm}/km</li>
                                                <li class="mb-2"><i class="bi bi-tag text-muted me-2"></i> Event:
                                                    ${pkg.eventType}</li>
                                            </ul>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="${pageContext.request.contextPath}/BookingController" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Event Date * <small class="text-muted">(Select
                                                    date first)</small></label>
                                            <input type="date" class="form-control" name="bookDate"
                                                id="outBookDateInput" required min=""
                                                onchange="loadOutdoorAvailableTimes()">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Start Time *</label>
                                            <select class="form-select" name="bookTime" id="outBookTimeSelect" required
                                                disabled>
                                                <option value="">-- Select date first --</option>
                                            </select>
                                            <small class="text-muted" id="outTimeHelpText">Please select a date to see
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control" name="bookPax" min="1" value="2"
                                                required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Distance from KL (km)</label>
                                            <input type="number" class="form-control" name="distance" id="outDistance"
                                                min="0" value="0" onchange="calculateTotal()">
                                            <small class="text-muted">Extra charge: RM <span
                                                    id="perKmRate">0</span>/km</small>
                                        </div>
                                    </div>

                                    <div class="mb-3">
                                        <label class="form-label">Event Location *</label>
                                        <input type="text" class="form-control" name="location" id="outLocation"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="notes" rows="3"
                                            placeholder="Wedding theme, special requests, etc."></textarea>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn" style="background: #2f5d50; color: white;">Confirm
                                        Booking</button>
                                </div>
                            </form>
                        </div>
