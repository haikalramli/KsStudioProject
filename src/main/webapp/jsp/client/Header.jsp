                ...
                <header id="header" class="header sticky-top">
                    ...
                    <div class="topbar d-flex align-items-center dark-background">
                        <div class="container d-flex justify-content-center justify-content-md-between">
                            ...
                            <div class="social-links d-none d-md-flex align-items-center">
                                <a href="https://www.tiktok.com/@ks_studio0" class="tiktok"><i
                                        class="bi bi-tiktok"></i></a>
                                <a href="https://www.instagram.com/kspictures.co" class="instagram"><i
                    ...
                    <div class="branding d-flex align-items-center">
                        <div class="container position-relative d-flex align-items-center justify-content-between">
                            <a href="${pageContext.request.contextPath}/jsp/client/Homepage.jsp"
                            ...
                            <nav id="navmenu" class="navmenu">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/jsp/client/Homepage.jsp"
                                            class="nav-home">Home</a></li>
                                    <li><a href="${pageContext.request.contextPath}/packages">Package</a></li>
                                    <li><a
                                            href="${pageContext.request.contextPath}/BookingController?action=list">Booking</a>
                                    </li>
                                    ...
                                    <c:choose>
                                        <c:when test="${not empty sessionScope.clientName}">
                                            <li class="dropdown">
                                                ...
                                                <ul>
                                                    <li><a
                                                            href="${pageContext.request.contextPath}/jsp/client/ViewAccount.jsp">Manage
                                                            Account</a></li>
                                                    <li><a
                                        ...
                                        <c:otherwise>
                                            <li><a href="${pageContext.request.contextPath}/jsp/client/Login.jsp"
                                                    class="nav-login"><i class="bi bi-box-arrow-in-right"></i> Login</a>
                                            </li>
                                        </c:otherwise>
                                    </c:choose>
                                </ul>
