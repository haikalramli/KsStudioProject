            ...
            <% if (session.getAttribute("clientID")==null) { response.sendRedirect("SignIn.jsp"); return; } %>
                ...
                <section class="section light-background" style="padding-top: 100px;">
                    <div class="container section-title" data-aos="fade-up">
                        ...
                        <p>Choose from our professional indoor studio packages. Perfect for portraits, corporate photos,
                            and celebrations.</p>
                    </div>
                                    ...
                                    <div class="card h-100 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><i class="bi bi-clock text-muted"></i> Duration: ${pkg.pkgDuration}
                                                    hours</li>
                                                <li><i class="bi bi-people text-muted"></i> Max Pax: ${pkg.numOfPax}
                                                </li>
                                                <li><i class="bi bi-image text-muted"></i> Background: ${pkg.backgType}
                                                </li>
                                                <li><i class="bi bi-tag text-muted"></i> Event Type: ${pkg.eventType}
                                                </li>
                                            </ul>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Select Date * <small class="text-muted">(Select
                                                    date first)</small></label>
                                            <input type="date" class="form-control" name="bookDate" id="bookDateInput"
                                                required min="" onchange="loadAvailableTimes()">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label">Select Time *</label>
                                            <select class="form-select" name="bookTime" id="bookTimeSelect" required
                                                disabled>
                                                <option value="">-- Select date first --</option>
                                            </select>
                                            <small class="text-muted" id="timeHelpText">Please select a date to see
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="bookPax" id="modalBookPax"
                                            min="1" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="location" value="KS Studio"
                                            readonly>
                                    </div>
