    ...
    <%@ taglib uri="jakarta.tags.core" prefix="c" %>
                    ...
                    <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                        <div class="hero-images">
                            <div class="main-image">
                                <img src="${pageContext.request.contextPath}/assets/img/homepage.PNG" alt="WeddingPic"
        ...
        <section id="offer-cards" class="offer-cards section light-background">
            <div class="container section-title" data-aos="fade-up">
                ...
                <h2>Package</h2>
                <p>Choose the perfect photography package for your special moments, whether you prefer a cozy indoor
                    session or a stunning outdoor experience.</p>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="offer-card" data-aos="zoom-in" data-aos-delay="200">
                            <div class="offer-image">
                                <img src="${pageContext.request.contextPath}/assets/img/indoor/HRG1.jpeg"
                                    alt="Indoor Package" class="img-fluid">
                            </div>
                            <div class="offer-content">
                                <h2>Indoor</h2>
                                <p>This is our signature indoor package, perfect for solo portraits, couples, and
                                    families. In our studio, you'll enjoy comfort, creativity, and professional
                                    lighting.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="offer-card featured" data-aos="zoom-in" data-aos-delay="300">
                            <div class="offer-image">
                                <img src="${pageContext.request.contextPath}/assets/img/outdoor/W2.jpeg"
                                    alt="Outdoor Package" class="img-fluid">
                            </div>
                            <div class="offer-content">
                                <h2>Outdoor</h2>
                                <p>This is our signature outdoor package, designed for weddings and events. Celebrate
                                    your special day beneath the open sky with a session that captures love and joy.</p>
