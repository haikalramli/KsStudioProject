                                ...
                                <c:if test="${!paymentVerified}">
                                    <div class="card shadow-sm text-center py-5" style="border-radius: 15px;">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted mb-4">Your photos will be available once your payment
                                                is verified.</p>
                                        ...
                                        <c:when test="${photo != null && not empty photo.folderLink}">
                                            <div class="card shadow-sm" style="border-radius: 15px; overflow: hidden;">
                                                <div class="card-header text-white"
                                                    style="background: linear-gradient(135deg, #2f5d50, #1a3a32);">
                                                    <h5 class="mb-0"><i class="bi bi-images"></i> ${photo.folderName}
                                                    </h5>
                                                </div>
                                                <div class="card-body text-center py-5">
                                                    ...
                                                    <p class="text-muted">Click the button below to access your photo
                                                        folder.</p>
                                                ...
                                                <c:if test="${not empty photo.notesForClient}">
                                                    <div class="card-footer bg-light">
                                                        <h6><i class="bi bi-chat-left-text"></i> Notes from
                                                            Photographer:</h6>
