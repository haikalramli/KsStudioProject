        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                .portal-card.senior .feature-list li i {
                    color: var(--senior-color);
                }

                .portal-card.junior .feature-list li i {
            ...
            <div class="main-container">
                ...
                <div class="portal-cards">
                    ...
                    <div class="portal-card client"
                        onclick="window.location.href='${pageContext.request.contextPath}/jsp/client/SignIn.jsp'">
                    ...
                    <!-- Senior (Admin) Portal -->
                    <div class="portal-card senior"
                        onclick="window.location.href='${pageContext.request.contextPath}/jsp/photographer/login.jsp?type=senior'">
                        <div class="card-header-custom">
                        ...
                        <div class="card-body-custom">
                            ...
                            <a href="${pageContext.request.contextPath}/jsp/photographer/login.jsp?type=senior"
                                class="btn-portal">
                    ...
                    <div class="portal-card junior"
                        onclick="window.location.href='${pageContext.request.contextPath}/jsp/photographer/login.jsp?type=junior'">
                        <div class="card-header-custom">
                        ...
                        <div class="card-body-custom">
                            ...
                            <a href="${pageContext.request.contextPath}/jsp/photographer/login.jsp?type=junior"
                                class="btn-portal">
