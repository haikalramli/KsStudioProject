                                ...
                                <div class="card shadow" style="border-radius: 15px;">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <c:if test="${not empty payment.depoRef}">
                                                    <tr class="table-success">
                                                        <td><i class="bi bi-check-circle text-success"></i> Deposit
                                                            Payment (30%)</td>
                                                        ...
                                                        <td class="text-end text-success">- RM
                                                            <fmt:formatNumber value="${booking.totalPrice * 0.3}"
                                                                pattern="#,##0.00" />
                                                        </td>
                                                    </tr>
                                                </c:if>
                                                ...
                                                <c:if test="${not empty payment.fullRef}">
                                                    <tr class="table-success">
                                                        ...
                                                        <td class="text-end text-success">- RM
                                                            <fmt:formatNumber value="${booking.totalPrice * 0.7}"
                                                                pattern="#,##0.00" />
                                                        </td>
                                                    </tr>
                                                </c:if>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-end text-success"><strong>RM
                                                            <fmt:formatNumber value="${payment.paidAmount}"
                                                                pattern="#,##0.00" />
                                                        </strong></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="text-end"><strong>Remaining Balance:</strong>
                                                    </td>
                                                    <td
                                                        class="text-end ${payment.remAmount > 0 ? 'text-danger' : 'text-success'}">
                                                        <strong>RM
                                        ...
                                        <div class="text-center my-4">
                                            <c:choose>
                                                <c:when
                                                    test="${payment.payStatus == 'verified' && payment.remAmount <= 0}">
                                                    <span class="badge bg-success fs-5 px-4 py-2"><i
                                                            class="bi bi-check-circle"></i> FULLY PAID</span>
                                                </c:when>
                                                <c:when test="${payment.payStatus == 'partial'}">
                                                    <span class="badge bg-warning text-dark fs-5 px-4 py-2"><i
                                                            class="bi bi-hourglass-split"></i> PARTIALLY PAID</span>
                                                </c:when>
                                                <c:when test="${payment.payStatus == 'submitted'}">
                                                    <span class="badge bg-info fs-5 px-4 py-2"><i
                                                            class="bi bi-clock"></i> PENDING VERIFICATION</span>
                                                </c:when>
                                                <c:otherwise>
                                                    <span
                                                        class="badge bg-secondary fs-5 px-4 py-2">${payment.payStatus}</span>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="text-center text-muted border-top pt-3">
                                            ...
                                            <p class="mb-0"><small>For inquiries, contact us at: info@ksstudio.com |
                                                    019-1234567</small></p>
                                        </div>
                                    </div>
                                </div>
