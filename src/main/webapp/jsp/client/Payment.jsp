            ...
            <% if (session.getAttribute("clientID")==null) { response.sendRedirect("SignIn.jsp"); return; } %>
                ...
                <section class="section light-background" style="padding-top: 100px;">
                    <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p><strong>Category:</strong>
                                                    <span
                                                        class="badge ${booking.packageCateg == 'Indoor' ? 'bg-info' : 'bg-success'}">${booking.packageCateg}</span>
                                                </p>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-center">
                                                ...
                                                <h4 class="text-success">RM
                                                    <fmt:formatNumber
                                                        value="${payment != null ? payment.paidAmount : 0}"
                                                        pattern="#,##0.00" />
                                                </h4>
                                            </div>
                                            <div class="col-md-4 text-center">
                                                <h6 class="text-muted">Remaining</h6>
                                                <h4 class="text-danger">RM
                                                    <fmt:formatNumber
                                                        value="${payment != null ? payment.remAmount : booking.totalPrice}"
                                                        pattern="#,##0.00" />
                                                </h4>
                                            </div>
                                        </div>
                                ...
                                <!-- Payment History -->
                                <c:if
                                    test="${payment != null && (not empty payment.depoRef || not empty payment.fullRef)}">
                                    <div class="card shadow-sm mb-4" style="border-radius: 15px;">
                                        <div class="card-header"
                                            style="border-radius: 15px 15px 0 0; background: #f8f9fa;">
                                        ...
                                        <div class="card-body">
                                            <c:if test="${not empty payment.depoRef}">
                                                <div
                                                    ...
                                                    <div>
                                                        <strong><i class="bi bi-cash-coin text-warning"></i> Deposit
                                                            Payment</strong><br>
                                                        <small class="text-muted">Ref: ${payment.depoRef}</small>
                                                        <c:if test="${payment.depoDate != null}">
                                                            <br><small class="text-muted">Date:
                                                                <fmt:formatDate value="${payment.depoDate}"
                                                                    pattern="dd MMM yyyy" />
                                                            </small>
                                                        </c:if>
                                                    </div>
                                                    <span
                                                        class="badge ${payment.payStatus == 'verified' || payment.payStatus == 'partial' ? 'bg-success' : 'bg-warning'}">
                                                        ${payment.payStatus == 'verified' || payment.payStatus ==
                                                        'partial' ? 'Verified' : 'Pending'}
                                                    </span>
                                                </div>
                                            </c:if>
                                            ...
                                            <c:if test="${not empty payment.fullRef}">
                                                <div
                                                    ...
                                                    <div>
                                                        <strong><i class="bi bi-cash-stack text-success"></i> Full
                                                            Payment</strong><br>
                                                        <small class="text-muted">Ref: ${payment.fullRef}</small>
                                                        <c:if test="${payment.fullDate != null}">
                                                            <br><small class="text-muted">Date:
                                                                <fmt:formatDate value="${payment.fullDate}"
                                                                    pattern="dd MMM yyyy" />
                                                            </small>
                                                        </c:if>
                                                    </div>
                                                    <span
                                                        class="badge ${payment.payStatus == 'verified' ? 'bg-success' : 'bg-warning'}">
                                ...
                                <c:if
                                    test="${payment != null && payment.payStatus == 'verified' && payment.remAmount <= 0}">
                                    <div class="alert alert-success">
                                        <h5><i class="bi bi-check-circle-fill"></i> Payment Complete!</h5>
                                        <p class="mb-0">Your payment has been fully verified. You can now access your
                                            photos.</p>
                                ...
                                <c:if test="${payment == null || payment.remAmount > 0}">
                                    <div class="card shadow-sm" style="border-radius: 15px;">
                                        <div class="card-header"
                                            style="border-radius: 15px 15px 0 0; background: linear-gradient(135deg, #2f5d50, #1a3a32);">
                                            <h5 class="mb-0 text-white"><i class="bi bi-credit-card"></i> Submit Payment
                                            </h5>
                                        </div>
                                        <div class="card-body">
                                            <!-- Bank Info -->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-check payment-option p-3 border rounded"
                                                            ...
                                                            <input class="form-check-input" type="radio"
                                                                name="paymentType" id="depositOption" value="deposit"
                                                                <c:if test="${empty payment.depoRef}">checked
                                </c:if>
                                ...
                                <label class="form-check-label w-100" for="depositOption">
                                    ...
                                    <span class="text-muted">RM
                                        <fmt:formatNumber value="${booking.totalPrice * 0.3}" pattern="#,##0.00" />
                                    </span>
                                    <c:if test="${not empty payment.depoRef}">
                        ...
                        <div class="col-md-6">
                            <div class="form-check payment-option p-3 border rounded" style="cursor: pointer;"
                                onclick="selectPaymentType('full')">
                                <input class="form-check-input" type="radio" name="paymentType" id="fullOption"
                                    value="full" <c:if test="${not empty payment.depoRef}">checked</c:if>>
                    ...
                    <form action="${pageContext.request.contextPath}/ClientPaymentController" method="post"
                        ...
                        <input type="hidden" name="paymentType" id="selectedPaymentType"
                            value="${empty payment.depoRef ? 'deposit' : 'full'}">

                        <div class="mb-3">
                            <label class="form-label fw-bold">Payment Reference Number *</label>
                            <input type="text" name="reference" class="form-control" placeholder="e.g., TRF123456789"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="amount" id="paymentAmount" class="form-control" step="0.01"
                                min="0.01" value="<fmt:formatNumber value=" ${empty payment.depoRef ? booking.totalPrice
                                * 0.3 : (payment !=null ? payment.remAmount : booking.totalPrice)}" pattern="#0.00" />"
                            required>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Upload your payment receipt image (PNG, JPG, GIF - Max
                                10MB)</small>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content" style="border-radius: 15px;">
                            ...
                            <div class="modal-body text-center py-4">
                                ...
                                <p class="text-muted" id="confirmMessage">Are you sure you want to submit this payment?
                                </p>
                            </div>
